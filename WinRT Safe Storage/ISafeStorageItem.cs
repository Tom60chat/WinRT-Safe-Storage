...
namespace WinRT_Safe_Storage
{
    public interface ISafeStorageItem
    {
        ...
        /// </returns>
        Task<SafeOperation<SafeStorageFolder>> TryGetParentAsync();
        ...
        /// </returns>
        Task<SafeOperation> TryRenameAsync(string desiredName);
        ...
        ///     otherwise <see langword="false"/>.
        /// </returns>
        Task<SafeOperation> TryRenameAsync(string desiredName, NameCollisionOption option);
        ...
        ///     otherwise <see langword="false"/>.
        /// </returns>
        Task<SafeOperation> TryDeleteAsync();
        ...
        ///     otherwise <see langword="false"/>.
        /// </returns>
        Task<SafeOperation> TryDeleteAsync(StorageDeleteOption option);
        ...
        ///     otherwise <see langword="null"/>.
        /// </returns>
        Task<SafeOperation<SafeBasicProperties>> TryGetBasicPropertiesAsync();
